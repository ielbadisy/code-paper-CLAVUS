...
renv.lock                 exact package versions used for the reported results
```
...
R 4.4.1. Key packages: `funcml` (>= 0.7.x, learner training / CV /
interpretability / ATE estimation), `mimar` (chained random-forest multiple
imputation), `ggplot2`, `patchwork`, `ragg`, `knitr`, `quarto`. Global random
seed: 20260427.
